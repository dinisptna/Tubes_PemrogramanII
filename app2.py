...
data = {
    'gender': st.selectbox('Jenis Kelamin', ['Laki-laki',
'Perempuan']),
    'married': st.selectbox('Status Pernikahan', ['Ya',
'Tidak']),
    'dependents': st.selectbox('Jumlah Tanggungan', ['0',
'1', '2', '3+']),
    'education': st.selectbox('Pendidikan', ['Sarjana',
'Tidak Sarjana']),
    'self_employed': st.selectbox('Wiraswasta', ['Ya',
'Tidak']),
    'applicant_income': st.number_input('PendapatanPemohon', min_value=0),
    ...
    'loan_amount_term': st.selectbox('Jangka Waktu Pinjaman(bulan)', 
[12.0, 36.0, 60.0, 84.0, 120.0, 180.0, 240.0, 300.0, 360.0, 480.0]),
    ...
    'property_area': st.selectbox('Area Properti',
    ['Pedesaan', 'Semiurban', 'Perkotaan']),
}
